# AI Coding Lyceum - TODO

## Phase 1: Foundation ✅
- [x] Initialize Next.js 16 project with Bun
- [x] Configure TailwindCSS v4 and shadcn/ui
- [x] Set up SQLite database with Drizzle ORM
- [x] Implement Auth.js v5 (GitHub/Google OAuth)
...
- [ ] Code syntax highlighting in discussions
